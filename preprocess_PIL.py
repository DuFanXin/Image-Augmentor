...
class DataAugmentation:
    ...
    def randomRotation(image, mode=Image.BICUBIC):
        ...
        :return: 旋转转之后的图像
        """
        for random_angle in range(360, 0, -10):
            image.rotate(random_angle, mode)
...
if __name__ == '__main__':
    threadOPS(path='/home/dufanxin/PycharmProjects/LearnTensorflow/input-data/Segmentation/l1',
              new_path='/home/dufanxin/PycharmProjects/LearnTensorflow/input-data/Segmentation/l2')
